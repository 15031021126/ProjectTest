package com.lohootech.modules.entity.base;
...
public class ServerResponse<T> implements Serializable {
    ...
    public static <T> ServerResponse<T> createByErrorCodeMessage(ResponseCode responseCode, T body){
        return new ServerResponse<T>(responseCode.getCode(),responseCode.getDesc(), body);
    }
